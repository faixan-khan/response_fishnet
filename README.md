...
The descriptions were not directly generated by GPT-4o. Instead, species-specific information was first collected from reliable sources such as FishBase and other authoritative references. GPT-4o was then used to extract visually discriminative attributes from these expert-verified texts to aid in classification. This approach ensures that the content is grounded in domain expertise, with GPT-4o's role focused on structuring the information to highlight visual cues relevant for downstream tasks. We agree that a manual evaluation of a larger subset of descriptions would strengthen our contribution. In the revised version, we will ensure that at least 500 descriptions are evaluated by domain experts to provide quantitative insights into description accuracy.
